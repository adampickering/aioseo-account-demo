...
<template>
	<div class="bg-white rounded-xl shadow-card p-8 flex flex-col">
		<!-- Title -->
		...
		<a
			:href="cartUrl"
			class="block w-full bg-brand-blue text-white text-center py-3 rounded-lg font-semibold hover:bg-brand-blue/90 transition-all duration-200"
		>
			Add to Cart
		</a>
	</div>
